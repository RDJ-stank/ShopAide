...
# ============================================================
# 种子数据 — 订单（13 个用户，覆盖全品类/全状态/全支付方式）
# ============================================================
_SEED_ORDERS: list[dict] = [
    # ---- 运输中 ----
    dict(order_id="GY10086", status="运输中", carrier="顺丰速运", tracking_number="SF1234567890",
        ...
        payment_method="微信支付"),
    dict(order_id="GY10099", status="运输中", carrier="京东物流", tracking_number="JD20260601001",
        ...
        payment_method="花呗分期"),
    dict(order_id="GY10101", status="运输中", carrier="圆通速递", tracking_number="YT20260602001",
        ...
        payment_method="支付宝"),
    dict(order_id="GY10105", status="运输中", carrier="中通快递", tracking_number="ZT20260602003",
    ...
    # ---- 已签收 ----
    dict(order_id="GY10010", status="已签收", carrier="中通快递", tracking_number="ZT9876543210",
        ...
        payment_method="支付宝"),
    dict(order_id="GY10012", status="已签收", carrier="顺丰速运", tracking_number="SF20260528001",
        ...
        payment_method="微信支付"),
    dict(order_id="GY10015", status="已签收", carrier="邮政EMS", tracking_number="EMS20260525001",
        ...
        payment_method="银行卡"),
    dict(order_id="GY10102", status="已签收", carrier="韵达快递", tracking_number="YD20260520001",
    ...
    # ---- 待发货 ----
    dict(order_id="GY20480", status="待发货", carrier="待分配", tracking_number="",
        ...
        payment_method="银行卡"),
    dict(order_id="GY10103", status="待发货", carrier="待分配", tracking_number="",
    ...
    # ---- 已取消 ----
    dict(order_id="GY10104", status="已取消", carrier="", tracking_number="",
...
_SEED_RETURNS: list[dict] = [
    ...
    dict(
        return_id="RTN20260601-001", order_id="GY10102",
        reason="净化器噪音过大", status="审核中",
        apply_time="2026-06-01 20:00", approved_time="",
        shipped_time="", received_time="",
        refund_time="", refund_amount=1299.00,
    ),
    dict(
        return_id="RTN20260602-001", order_id="GY10015",
        reason="吸尘器充电底座故障", status="待寄回",
        apply_time="2026-06-02 10:00", approved_time="2026-06-02 15:00",
        shipped_time="", received_time="",
        refund_time="", refund_amount=0.00,  # 换货不退款
    ),
]
...
_SEED_DISPUTES: list[dict] = [
    ...
    dict(
        case_id="DSP20260602-001", order_id="GY10012",
